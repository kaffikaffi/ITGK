...
# Svar: løkken skriver ut 4-gangen opp til 10.  ( 4 : dette tallet går opp i 4-gangern) ( 8 : dette tallet går opp i 4-gangern) 
...
# Skriver ut 2-gangern opp til 8. 
...
# ## Svar:8, ettersom print ikke er indented. 
